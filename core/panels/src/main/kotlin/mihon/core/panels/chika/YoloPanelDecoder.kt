 ...
 * shared/src/commonMain/kotlin/com/chakra/comicreader/detection/YoloPanelDecoder.kt.
 *
 ...
 *
 * NOTE: this decodes the *algorithm* chika uses to turn a YOLO output tensor into panel boxes.
 * It is independent of any specific model's trained weights — see mihon.core.panels.TfliteChikaDetector
 * for why this project does not bundle chika's own manga_panel_detector_int8.tflite asset.
 */
...
class YoloPanelDecoder(
    ...
    companion object {
        ...
        // The single source of truth for decoder tuning.
